...
public class AggregationStarter {
    ...
    @Value(value = "${topics.snapshot}")
    private static String SNAPSHOT_TOPIC;

    @Value(value = "${topics.sensors-events}")
    private static String topicSensor;

    private static final List<String> TOPICS = List.of(topicSensor);
